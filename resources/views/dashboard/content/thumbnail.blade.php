...
<div class="bdgs-sf__tabs">
  <a href="{{ route('dashboard.content.edit', [$type, $post]) }}" class="bdgs-sf__tab">Edit {{ $dataType->name }}</a>
  <a href="{{ route('dashboard.content.thumbnail', [$type, $post]) }}" class="bdgs-sf__tab bdgs-sf__tab--active">Upload Thumbnail</a>
</div>
...
<div class="bdgs-thumb">
  @if ($post->featuredMedia)
    <div class="bdgs-thumb__current">
      ...
      <form method="POST" action="{{ route('dashboard.content.thumbnail.remove', [$type, $post]) }}">
        @csrf
        @method('DELETE')
  ...
  <div class="bdgs-thumb__upload-section">
    ...
    <form method="POST" action="{{ route('dashboard.content.thumbnail.upload', [$type, $post]) }}" enctype="multipart/form-data" class="bdgs-thumb__upload-form">
      @csrf
