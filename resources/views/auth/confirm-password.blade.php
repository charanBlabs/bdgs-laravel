...
@section('title')
<title>Confirm Password — BD Growth Suite</title>
@endsection
...
<form method="POST" action="{{ route('password.confirm') }}" class="bdgs-auth-form">
  @csrf
  ...
  <button type="submit" class="bdgsownv2-btn-primary bdgs-auth-submit">Confirm</button>
</form>
@endsection
