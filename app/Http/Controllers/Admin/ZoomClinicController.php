...
class ZoomClinicController extends Controller
{
    ...
    {
        return view('admin.zoom-clinics.form', [
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.zoom-clinics.edit', $clinic->clinic_id)
    ...
    public function edit(int $clinicId): View
    {
        ...
        return view('admin.zoom-clinics.form', compact('clinic'));
    }
    ...
    public function destroy(int $clinicId): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.zoom-clinics.index')
    ...
    private function validateClinic(Request $request, ?int $clinicId = null): array
    {
        return $request->validate([
            ...
            'zoom_meeting_url' => ['required', 'url', 'max:1000'],
